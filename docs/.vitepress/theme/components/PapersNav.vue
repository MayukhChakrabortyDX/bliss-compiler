<template>
  <nav class="papers-nav" aria-label="Papers navigation">
...
@media (max-width: 760px) {
  ...
  .papers-nav__menu-button { width: 44px; height: 44px; display: grid; place-content: center; gap: 4px; border: 1px solid var(--bliss-border); border-radius: 12px; background: rgb(255 255 255 / 72%); color: var(--bliss-fg); }
  .papers-nav__menu-button span { width: 17px; height: 1.5px; background: currentColor; }
  .papers-nav__mobile-menu { position: absolute; top: calc(100% - 4px); right: 1rem; left: 1rem; display: grid; gap: 2px; padding: 8px; border: 1px solid var(--bliss-border); border-radius: 16px; background: rgb(255 255 255 / 96%); box-shadow: var(--bliss-shadow-lg); }
